...
def solve(maze):
    ...
    # Visited holds true/false on whether a node has been seen already. Used
    # to stop us returning to nodes multiple times
    visited = [False] * total

    # Previous holds a link to the previous node in the path. Used at the end
    # for reconstructing the route
    prev = [None] * total
    ...
    # To begin, we set the distance to the start to zero (we're there) and add
    # it into the unvisited queue
                ...
                if visited[vposindex] == False:
                    ...
                    if newdistance < distances[vposindex]:
                        ...
                        if vnode == None:
                            ...
                            prev[vposindex] = u
                        # v is already in the queue - decrease its key to
                        # re-prioritise it
                        else:
